...
class FeatureSelection:
    ...
    The class computes all feature selection strategies once and
    subsequently evaluates feature stability by counting how often
    individual features are selected across methods.
    """
    # ------------------------------------------------------------------
    ...
    # Best feature from each "features group"
    ...
    all_dicts = [
        selected_kw,
        selected_spearman,
        best_one_group_spearman,
        best_one_group_kw,
        rf_classification_all,
        rf_classification_significant,
        rf_regression_all,
        rf_regression_significant,
        lasso_regression_all,
        lasso_regression_significant,
        mi_classification,
        mi_regression,
        filtered_spearman,
        filtered_kw,
        mrmr_classification_1_all,
        mrmr_classification_1_significant,
        mrmr_classification_2_all,
        mrmr_classification_2_significant,
        mrmr_regression_all,
        mrmr_regression_significant,
    ]

    @staticmethod
    def _print_count_tables(tables: dict[str, pd.DataFrame]) -> None:
        """
        Print feature occurrence tables filtered to features
        selected more than once.

        Parameters: tables: Dictionary mapping dataset names to count tables.
        """
    ...
    def count_tables(self) -> None:
        ...
        The method aggregates results, computes absolute counts,
        relative ratios and percentages, and prints summary tables.
        """
