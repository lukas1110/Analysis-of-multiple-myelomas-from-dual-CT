...
# ct_40 = NiftiFile(r"C:\Users\lukas\OneDrive - VUT\Plocha\Diploma thesis\Myel_001\myel_001_monoe_40kev.nii.gz").get_image_data()
# ct_80 = NiftiFile(r"C:\Users\lukas\OneDrive - VUT\Plocha\Diploma thesis\Myel_001\myel_001_monoe_80kev.nii.gz").get_image_data()
# ct_120 = NiftiFile(r"C:\Users\lukas\OneDrive - VUT\Plocha\Diploma thesis\Myel_001\myel_001_monoe_120kev.nii.gz").get_image_data()
# mask = NiftiFile(r"C:\Users\lukas\OneDrive - VUT\Plocha\Diploma thesis\Myel_001\myel_001_spine_seg_nnUNet_cor.nii.gz").get_image_data()

# v_40 = np.var(ct_40[mask == 3])
# v_80 = np.var(ct_80[mask == 3])
# v_120 = np.var(ct_120[mask == 3])


# vmi_40 = pd.read_csv(r"C:\Users\lukas\OneDrive - VUT\Plocha\Diploma thesis\Myel_001\monoe_40kev_radiomics_spine_lesions_features.csv")
# vmi_80 = pd.read_csv(r"C:\Users\lukas\OneDrive - VUT\Plocha\Diploma thesis\Myel_001\monoe_80kev_radiomics_spine_lesions_features.csv")
# vmi_120 = pd.read_csv(r"C:\Users\lukas\OneDrive - VUT\Plocha\Diploma thesis\Myel_001\monoe_120kev_radiomics_spine_lesions_features.csv")

# raw_datasets = {'vmi_40': vmi_40/v_40, 'vmi_80': vmi_80/v_80, 'vmi_120': vmi_120/v_120}




# ct_25 = NiftiFile(r"C:\Users\lukas\OneDrive - VUT\Plocha\Diploma thesis\Myel_001\myel_001_CaSupp_25.nii.gz").get_image_data()
# ct_50 = NiftiFile(r"C:\Users\lukas\OneDrive - VUT\Plocha\Diploma thesis\Myel_001\myel_001_CaSupp_50.nii.gz").get_image_data()
# ct_75 = NiftiFile(r"C:\Users\lukas\OneDrive - VUT\Plocha\Diploma thesis\Myel_001\myel_001_CaSupp_75.nii.gz").get_image_data()
# ct_100 = NiftiFile(r"C:\Users\lukas\OneDrive - VUT\Plocha\Diploma thesis\Myel_001\myel_001_CaSupp_100.nii.gz").get_image_data()
# mask = NiftiFile(r"C:\Users\lukas\OneDrive - VUT\Plocha\Diploma thesis\Myel_001\myel_001_spine_seg_nnUNet_cor.nii.gz").get_image_data()

# c25 = np.var(ct_25[mask == 3])
# c50 = np.var(ct_50[mask == 3])
# c75 = np.var(ct_75[mask == 3])
# c100 = np.var(ct_100[mask == 3])
...
# raw_datasets = {'c_25': c_25/c25, 'c_50': c_50/c50, 'c_75': c_75/c75, 'c_100': c_100/c100}
